...
DefinitionsUpdatereply = {'properties': {'content': {'type': 'string'}, 'post_id': {'type': 'string'}, 'account_id': {'type': 'integer', 'format': 'int32'}, 'is_sticky': {'type': 'boolean'}, 'is_hidden': {'type': 'boolean'}, 'review_status': {'enum': ['pending', 'passed', 'rejected', 'auto_passed'], 'type': 'string'}, 'column_id': {'type': 'string'}}}
...
DefinitionsArticlelite = {'properties': {'status': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'account': DefinitionsAccount, 'views_count': {'type': 'integer', 'format': 'int32'}, 'title': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'id': {'type': 'string'}}}
DefinitionsPostlite = {'properties': {'account': DefinitionsAccount, 'description': {'type': 'string'}, 'is_sticky': {'type': 'boolean'}, 'title': {'type': 'string'}, 'review_status': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'id': {'type': 'string'}}}
DefinitionsReply = {'properties': {'content': {'type': 'string'}, 'account': DefinitionsAccount, 'is_sticky': {'type': 'boolean'}, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'review_status': {'type': 'string'}, 'id': {'type': 'string'}}}
DefinitionsArticle = {'properties': {'status': {'type': 'string'}, 'account': DefinitionsAccount, 'voice': DefinitionsVoicelite, 'views_count': {'type': 'integer', 'format': 'int32'}, 'title': {'type': 'string'}, 'column_id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'summary': {'type': 'string'}, 'id': {'type': 'string'}}}
DefinitionsPost = {'properties': {'account': DefinitionsAccount, 'description': {'type': 'string'}, 'is_sticky': {'type': 'boolean'}, 'title': {'type': 'string'}, 'review_status': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'id': {'type': 'string'}}}
DefinitionsColumnlite = {'properties': {'status': {'type': 'string'}, 'account': DefinitionsAccount, 'views_count': {'type': 'integer', 'format': 'int32'}, 'price': {'type': 'integer'}, 'date_created': DefinitionsDatetime, 'follows_count': {'type': 'integer', 'format': 'int32'}, 'id': {'type': 'string'}, 'name': {'type': 'string'}}}
...
DefinitionsReplylite = {'properties': {'content': {'type': 'string'}, 'account': DefinitionsAccount, 'is_sticky': {'type': 'boolean'}, 'is_hidden': {'type': 'boolean'}, 'review_status': {'type': 'string'}, 'id': {'type': 'string'}}}
