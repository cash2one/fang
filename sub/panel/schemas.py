...
DefinitionsColumn = {'properties': {'status': {'type': 'string'}, 'account': DefinitionsAccount, 'name': {'type': 'string'}, 'price': {'type': 'integer'}, 'date_start': DefinitionsDatetime, 'id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'subscribes_count': {'type': 'integer', 'format': 'int32'}, 'date_end': DefinitionsDatetime}}
