...
DefinitionsArticlelite = {'properties': {'status': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'account': DefinitionsAccount, 'title': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'id': {'type': 'string'}, 'column_id': {'type': 'string'}}}
...
DefinitionsArticle = {'properties': {'status': {'type': 'string'}, 'account': DefinitionsAccount, 'voice': DefinitionsVoice, 'title': {'type': 'string'}, 'column_id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'summary': {'type': 'string'}, 'id': {'type': 'string'}}}
...
DefinitionsPostlite = {'properties': {'account': DefinitionsAccount, 'description': {'type': 'string'}, 'title': {'type': 'string'}, 'is_sticky': {'type': 'boolean'}, 'review_status': {'type': 'string'}, 'column_id': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'id': {'type': 'string'}}}
...
DefinitionsColumn = {'properties': {'status': {'type': 'string'}, 'account': DefinitionsAccount, 'subscribes_count': {'type': 'integer', 'format': 'int32'}, 'name': {'type': 'string'}, 'image': {'type': 'string'}, 'date_start': DefinitionsDatetime, 'id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'is_hidden': {'type': 'boolean'}, 'price': {'type': 'integer'}, 'date_end': DefinitionsDatetime}}
DefinitionsReplylite = {'properties': {'account': DefinitionsAccount, 'is_sticky': {'type': 'boolean'}, 'review_status': {'type': 'string'}, 'column_id': {'type': 'string'}, 'content': {'type': 'string'}, 'post_id': {'type': 'string'}, 'is_hidden': {'type': 'boolean'}, 'id': {'type': 'string'}, 'date_published': DefinitionsDatetime}}
...
validators = {
    ...
    ('articles', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'status': {'required': False, 'description': 'status in query', 'enum': ['draft', 'published'], 'type': 'string'}, 'account_id': {'description': 'account id in query', 'format': 'int32', 'required': False, 'type': 'integer'}, 'title': {'required': False, 'type': 'string', 'description': 'title in query'}, 'column_id': {'required': False, 'type': 'string', 'description': u'\u4e13\u680fID'}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 20000}, 'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'is_hidden': {'required': False, 'type': 'boolean', 'description': 'is_hidden in query'}, 'id': {'required': False, 'type': 'string', 'description': 'ID'}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 1000}}}},
    ('columns', 'POST'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'json': DefinitionsCreatecolumn},
    ('columns', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'status': {'required': False, 'description': 'status in query', 'enum': ['draft', 'published'], 'type': 'string'}, 'account_id': {'description': 'account id in query', 'format': 'int32', 'required': False, 'type': 'integer'}, 'id': {'required': False, 'type': 'string', 'description': 'ID'}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 20000}, 'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'is_hidden': {'required': False, 'type': 'boolean', 'description': 'is_hidden in query'}, 'nickname': {'required': False, 'type': 'string', 'description': 'nickname in query'}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 1000}}}},
    ...
    ('columns_id_articles', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'status': {'required': False, 'description': 'status in query', 'enum': ['draft', 'published'], 'type': 'string'}, 'account_id': {'description': 'account id in query', 'format': 'int32', 'required': False, 'type': 'integer'}, 'is_sticky': {'required': False, 'type': 'boolean', 'description': 'is_sticky in query'}, 'title': {'required': False, 'type': 'string', 'description': 'title in query'}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 20000}, 'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'is_hidden': {'required': False, 'type': 'boolean', 'description': 'is_hidden in query'}, 'article_id': {'required': False, 'type': 'string', 'description': u'\u6587\u7ae0ID'}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 1000}}}},
    ...
    ('posts', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string'}}}, 'args': {'required': [], 'properties': {'account_id': {'description': 'account id in query', 'format': 'int32', 'required': False, 'type': 'integer'}, 'is_sticky': {'required': False, 'type': 'boolean', 'description': 'is_sticky in query'}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 20000}, 'review_status': {'required': False, 'description': 'review_status in query', 'enum': ['pending', 'passwd', 'rejected', 'auto_passed'], 'type': 'string'}, 'column_id': {'required': False, 'type': 'string', 'description': u'\u4e13\u680fID'}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'column_account_id': {'required': False, 'type': 'string', 'description': u'\u4e13\u680f\u7528\u6237ID'}, 'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'is_hidden': {'required': False, 'type': 'boolean', 'description': 'is_hidden in query'}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 1000}}}},
...
filters = {
    ...
    ('columns_id_articles', 'GET'): {200: {'headers': None, 'schema': {'items': DefinitionsArticlelite, 'type': 'array'}}},
