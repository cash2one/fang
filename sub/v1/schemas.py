...
DefinitionsArticle = {'properties': {'account_id': {'type': 'integer'}, 'title': {'type': 'string'}, 'date_updated': DefinitionsDatetime, 'html_content': {'type': 'string'}, 'summary': {'type': 'string'}, 'column_id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'voice': DefinitionsVoicelite, 'id': {'type': 'string'}}}
