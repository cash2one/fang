...
DefinitionsPost = {'properties': {'description': {'type': 'string'}, 'is_sticky': {'type': 'boolean'}, 'date_updated': DefinitionsDatetime, 'title': {'type': 'string'}, 'column_id': {'type': 'string'}, 'date_created': DefinitionsDatetime, 'replies_count': {'type': 'integer'}, 'id': {'type': 'string'}, 'account_id': {'type': 'integer'}}}
