...
DefinitionsArticle = {'properties': {'account_id': {'type': 'integer'}, 'title': {'type': 'string'}, 'date_updated': DefinitionsDatetime, 'summary': {'type': 'string'}, 'column_id': {'type': 'string'}, 'content': {'type': 'string'}, 'date_published': DefinitionsDatetime, 'date_created': DefinitionsDatetime, 'voice': DefinitionsVoicelite, 'id': {'type': 'string'}}}
...
DefinitionsPostdetail = {'properties': {'is_presenter': {'type': 'boolean'}}, 'allOf': [DefinitionsPost, {'type': 'object'}]}
