...
class RequestHandler(BaseRequestHandler):
    ...
    def log_request(self, code='-', size='-'):
        requestline = smart_str(urllib.unquote(self.requestline).decode('utf8'))
...
@manager.option('-p', '--package', help='Package name / application name', default='sub')
